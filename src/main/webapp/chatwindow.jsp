...
<div class="row placeholders">
	<h1 id="chatwindowtitle" class="page-header">选择好友开始聊天</h1>
...
<!-- 		<input type="file" id="exampleInputFile" style="display:none"> -->
		...
		<button id="sendMessage" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-primary" style="width:250px;margin:2px">还不知道要用来干嘛的按钮</button>
	</div>
